...
class FoodTruck(gym.Env):
    ...
    def __init__(self, reward_type = "version_1", time_cost = -0.01, hit_wall_cost=-2):
        ...
        self.terminate = np.zeros(self.n_states)

        self.terminate[self.coord_to_state(self.rest1_x[0],self.rest1_y[0])] = 1
        self.terminate[self.coord_to_state(self.rest2_x[0],self.rest2_y[0])] = 1
        self.terminate[self.coord_to_state(self.rest3_x[0],self.rest3_y[0])] = 1
        self.terminate[self.coord_to_state(self.rest4_x[0],self.rest4_y[0])] = 1
    ...
    def render(self):
        ...
        if self.state is not None:
            truck_x = 0.5/self.w + self.state_to_coord(self.state)[0]/self.w 
            truck_y = 0.5/self.h + self.state_to_coord(self.state)[1]/self.h
    ...
    def draw_values(self, values):
        ...
        self._draw_floats(self.R, v_offset=0.8, label="r")
